...
if __name__ == '__main__':
    ...
    base_path = Path(DATA_PATH, 'warm_reloaded/test_set/optical')
    base_path_ir = Path(DATA_PATH, 'warm_reloaded/test_set/thermal')
    image_paths = sorted(list(base_path.iterdir()))
    image_paths_ir = sorted(list(base_path_ir.iterdir()))
    output_dir = Path(DATA_PATH, 'warm_reloaded/patches/')
