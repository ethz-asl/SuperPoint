...
if __name__ == '__main__':
    ...
    base_path = Path(DATA_PATH, 'one_image_aerial_two/optical')
    base_path_ir = Path(DATA_PATH, 'one_image_aerial_two/thermal')
    image_paths = sorted(list(base_path.iterdir()))
    image_paths_ir = sorted(list(base_path_ir.iterdir()))
    output_dir = Path(DATA_PATH, 'one_image_aerial_two/patches/')
